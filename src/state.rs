...
impl state::GroundState {
    ...
    ///     InfAfterStep { src: Coord(AU, P), step: Coord(AU, M), planned_direction: Coord(AU, ExcitedState) },
    ...
    ///     InfAfterStep { src: Coord(AU, M), step: Coord(AU, X), planned_direction: Coord(AU, ExcitedState) },
    ...
    ///     InfAfterStep { src: Coord(AU, M), step: Coord(AU, P), planned_direction: Coord(AU, ExcitedState) },
    ///     InfAfterStep { src: Coord(AU, X), step: Coord(AI, ExcitedState), planned_direction: Coord(Y, X) },
    ///     InfAfterStep { src: Coord(AU, X), step: Coord(AI, ExcitedState), planned_direction: Coord(O, P) },
    ///     InfAfterStep { src: Coord(AU, X), step: Coord(AI, ExcitedState), planned_direction: Coord(Y, M) },
    ///     InfAfterStep { src: Coord(AU, X), step: Coord(AI, ExcitedState), planned_direction: Coord(AU, X) },
